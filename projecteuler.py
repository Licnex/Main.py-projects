...
def project_euler_13():
    def find_sum_of_digits(num_str, digits):
        """Finds the first few digits sum of the list of numbers which comes from a string provided"""
        temp_num = num_str.split("\n")
        numbers = []
    ...
    print(find_sum_of_digits("""37107287533902102798797998220837590246510135740250
